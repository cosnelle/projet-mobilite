...
function affichage_lieux(data, type){
  ...
  for (let r of data.lieu){
    // recuperation des coordonnees GPS du centre de la commune de domicile
    let url_coordonnees =`https://geo.api.gouv.fr/communes?codePostal=${r.domicile}&fields=centre`; 
...
function tracer_ligne(data1, data2, weight, trait){
